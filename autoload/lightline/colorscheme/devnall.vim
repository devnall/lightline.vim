" =============================================================================
" Filename: autoload/lightline/colorscheme/devnall.vim
" Author: devnall
" License: MIT License
" Last Change: 2018/11/08 22:58:54.
" =============================================================================
...
let s:p.visual.left = [ [ s:veryDarkGray, s:yellow ], [ s:white, s:gray ] ]
...
let g:lightline#colorscheme#NewHope#palette = lightline#colorscheme#flatten(s:p)
